...
| ------ | -------- | ----- |
| [workflow](workflow/) | Initializing a project docs knowledge base, planning work into reviewable docs, splitting it into tasks, implementing it test-first, and reviewing it with a verified panel | `/install`, `/to-plan`, `to-tasks`, `/implement`, `to-review` |
